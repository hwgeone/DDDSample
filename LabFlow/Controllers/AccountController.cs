using LabFlow.Extensions;
using LabFlow.Infra.CrossCutting.Identity.Extensions;
using LabFlow.Infra.CrossCutting.Identity.Models;
using LabFlow.Infra.CrossCutting.Identity.Models.AccountViewModels;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    // User claim for write Tiger data
                    await _userManager.AddClaimAsync(user, new Claim("Tigers", "Write"));
